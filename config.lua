...
---------------------
-- Enter Replace Mode Real Quick
lvim.builtin.which_key.mappings["/"] = { ":%s/", "Enter Replace Mode Real Quick" }
-- Format Code
lvim.keys.normal_mode["<leader>d"] = ":lua vim.lsp.buf.formatting_sync()<cr>"
-- Navigate buffers right
lvim.keys.normal_mode["<S-Right>"] = ":bnext<CR>"
-- Navigate buffers left
